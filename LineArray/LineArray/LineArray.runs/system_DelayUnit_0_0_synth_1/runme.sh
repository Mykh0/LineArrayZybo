...
HD_PWD='C:/EAAES/asignments/LineArray/LineArray.runs/system_DelayUnit_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_DelayUnit_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_DelayUnit_0_0.tcl
