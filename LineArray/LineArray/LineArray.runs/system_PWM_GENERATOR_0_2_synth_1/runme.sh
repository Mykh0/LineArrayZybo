...
HD_PWD='C:/EAAES/asignments/LineArray/LineArray.runs/system_PWM_GENERATOR_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_PWM_GENERATOR_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_PWM_GENERATOR_0_2.tcl
