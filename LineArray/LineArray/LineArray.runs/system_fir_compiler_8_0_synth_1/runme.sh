...
HD_PWD='C:/Users/Mykho/Documents/repos/LineArrayZybo/LineArray/LineArray/LineArray.runs/system_fir_compiler_8_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_fir_compiler_8_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_fir_compiler_8_0.tcl
