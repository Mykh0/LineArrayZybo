...
################################################################
# This is a generated script based on design: Translator_v1_0_bfm_1
#
...
# source Translator_v1_0_bfm_1_script.tcl
...
set design_name Translator_v1_0_bfm_1
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Translator_1, and set properties
  set Translator_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:Translator:1.0 Translator_1 ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Translator_1/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Translator_1/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins Translator_1/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Translator_1/S00_AXI/S00_AXI_reg] SEG_Translator_1_S00_AXI_reg
...
preplace inst Translator_1 -pg 1 -lvl 3 -y 340 -defaultsOSRD
...
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 420 -10 720
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 30 480 450 480 730J
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 710
levelinfo -pg 1 0 220 580 860 1010 -top -50 -bot 490
",
}
